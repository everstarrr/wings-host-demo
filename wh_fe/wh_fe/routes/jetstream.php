    ...
    Route::group(['middleware' => array_values(array_filter([$authMiddleware, $authSessionMiddleware]))], function () {
        ...
        Route::group(['middleware' => 'verified'], function () {
            ...
            if (Jetstream::hasTeamFeatures()) {
                ...
                Route::put('/current-team-to-servers', function (\Illuminate\Http\Request $req) {
                    (new CurrentTeamController())->update($req);
                    return redirect(\route('dash.servers'));
                })->name('current-team-to-servers.update');
            ...
            // Route::put('/formal', [FormalController::class, 'update'])->name('formal.update');
        });
    });
});
