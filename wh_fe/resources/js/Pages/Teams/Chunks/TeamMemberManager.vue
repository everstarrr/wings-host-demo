...
<template>
    <div>
            ...
            <FormSection @submitted="addTeamMember">
                ...
                <template #form>
                    ...
                    <div
                        ...
                        <InputLabel
                            for="roles"
                            :value="$t('groups.add_member_role')" />
                        <InputError
                            :message="addTeamMemberForm.errors.role"
                            class="mt-2" />

                        <div class="relative z-0 mt-1 border border-neutral-700 rounded-lg cursor-pointer">
                            <button
                                ...
                                :class="{
                                    'border-t border-neutral-700 focus:border-none rounded-t-none': i > 0,
                                    'rounded-b-none': i != Object.keys(availableRoles).length - 1,
                                    'border-neutral-300 ring-2 ring-neutral-300': addTeamMemberForm.role == role.key,
                                }"
                                ...
                                <div
                                    ...
                                    <!-- Role Description -->
                                    <div class="mt-2 text-xs text-neutral-400 text-left">
                                        {{ role.description }}
                                    </div>
                                </div>
                            </button>
                        ...
                        <div
                            ...
                            <div class="flex items-center">
                                <img
                                    ...
                                    :alt="user.u_name" />
                                <div class="ml-4 text-neutral-300">{{ user.u_name }} | {{ user.email }}</div>
                            </div>
        ...
        <ConfirmationModal
            ...
            <template #title>
                {{ $t("groups.delete_member") }}
            </template>

            <template #content>
                {{ $t("groups.delete_member_notice") }}
            </template>
