                        ...
                        <div
                            ...
                            <label class="flex items-center">
                                <Checkbox
                                    ...
                                    :value="permission" />
                                <span class="ml-2 text-sm text-neutral-400">{{ permission }}</span>
                            </label>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-6">
                            <div
                                ...
                                <div class="flex items-center ml-2">
                                    ...
                                    <button
                                        v-if="availablePermissions.length > 0"
                                        class="cursor-pointer ml-6 text-sm text-neutral-400 underline"
        ...
        <DialogModal
            ...
            <template #content>
                ...
                <div
                    ...
                    class="mt-4 bg-neutral-900 px-4 py-2 rounded font-mono text-sm text-neutral-500 break-all">
