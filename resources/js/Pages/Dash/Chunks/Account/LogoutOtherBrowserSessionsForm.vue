...
<template>
    <ActionSection>
        ...
        <template #description>
            {{ $t("account.devices_notice") }}
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-neutral-400">
                {{ $t("account.devices_notice2") }}
            </div>
                    ...
                    <div>
                            ...
                            <path
                                ...
                                d="M9 17.25v1.007a3 3 0 01-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0115
                                 18.257V17.25m6-12V15a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013
                                  15V5.25m18 0A2.25 2.25 0 0018.75 3H5.25A2.25 2.25 0 003 5.25m18
                                   0V12a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 12V5.25" />
                        </svg>
                        ...
                        <svg
                            ...
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                                d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018
                                 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
                        </svg>
                    </div>
                        ...
                        <div>
                            <div class="text-xs text-neutral-500">
                                ...
                                <span
                                    ...
                                    >{{ $t("account.devices_this_device") }}</span
                                >
                                <span v-else>{{ $t("account.devices_last_active") }} {{ session.last_active }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex items-center mt-5">
                <button
                    @click="confirmLogout"
                    type="button"
                    class="w-max px-6 py-auto h-10 leading-4 font-['OpenSans-Medium'] rounded-lg text-neutral-900 bg-neutral-300 hover:bg-neutral-400 focus:bg-neutral-400 transition-all duration-150 ease-in-out block">
            ...
            <DialogModal
                ...
                @close="closeModal">
                <template #title>
                    {{ $t("account.devices_logout_all") }}
                </template>

                <template #content>
                    {{ $t("account.devices_logout_all_password") }}
